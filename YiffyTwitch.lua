...
-- Version 231 [Yiffy Twitch re-release]
...
function VisualManager:OnDraw()
	...
	if PopUp1 then	-- Draw instructions Box and Text
		...
		DrawTextA(tostring("Script should Auto E when killable (if you know how to fix this PM me!)"), WINDOW_H*.015, (WINDOW_W/2.65), (WINDOW_H*.315), ARGB(255, 255, 255, 255))
